# E19 finder — the context engine's rulers (R-DEPTH) — 2026-09-20 18:49 IST
...
- **On probation:** 0  ·  **Waiting for lane (not green):** 3  ·  **Green, reader not wired yet:** 1

| ruler | context lane | lane state | recorded | E19 status |
|---|---|---|---|---|
| **depth-5-level** — the 5-level order-book (bid/ask sizes at five prices) | E13 microstructure | 🔴 red | 0 | waiting-for-lane |
...
| **breadth** — how many names are advancing vs declining together | L16 breadth | 🟢 green | 892 | green-awaiting-reader |
